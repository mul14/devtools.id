...
<template>
  <div class>
    <h1 class="font-normal text-2xl text-darkBlue uppercase">Slug Generator</h1>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div>
        <textarea
          v-model="output"
          class="block w-full shadow-custom rounded-md border-indigo-500 py-3 px-4 focus:border-indigo-500 focus:ring-indigo-500 bg-gray-100"
          rows="8"
          readonly
        ></textarea>
      </div>
